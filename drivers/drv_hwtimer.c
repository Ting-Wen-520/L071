...
static void timer_init(struct rt_hwtimer_device *timer, rt_uint32_t state)
{
    ...
    if (state)
    {
        ...
        if (tim->Instance == TIM21 || tim->Instance == TIM22 )
...
#if defined(SOC_SERIES_STM32F1) || defined(SOC_SERIES_STM32L4) || defined(SOC_SERIES_STM32F0) || defined(SOC_SERIES_STM32G0) || defined(SOC_SERIES_STM32L0)
...
#endif
        {
#if defined(SOC_SERIES_STM32L4) || defined(SOC_SERIES_STM32L0)
...
#elif defined(SOC_SERIES_STM32F0) || defined(SOC_SERIES_STM32G0) || defined(SOC_SERIES_STM32L0)
